...
@section('content')
    ...
    <div class="content">
        ...
        <form id="auth-form" method="POST" action="/auth/confirm" enctype="multipart/form-data">
            @csrf
            ...
            <button type="sybmit" class="btn">Войти</button>

        </form>

        <form id="reg-form" method="POST" action="/register/confirm" enctype="multipart/form-data"
            style="display:none;>
            @csrf
    ...
    <button type="sybmit" class="btn">Зарегистрироваться</button>
